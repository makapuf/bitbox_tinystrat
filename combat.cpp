...
struct Opponent {
    ...
    Opponent(bool left, Unit &unit)
    {
        ...
        bg = sprite3_new(terrain_bg_table[terrain],left ? 0 : 200, left?-200:300,35);

        sprite = sprite3_new( data_units_16x16_spr, left ? -30 : 410, 180, 5 );
        // also other units ...
        ...
        life = sprite3_new(data_bignum_16x24_spr, left ? 34 : 340,52,5);
        life->fr = unit.health();

        face = sprite3_new(data_faces_26x26_spr,left ? 0:360,52,5);
